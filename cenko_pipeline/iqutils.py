...
def sdss2jkc(infile, outfile="", outformat="reg"):
    ...
    try:
        ...
        for star in stars:
            ...
            star.mags['VMAG'] = star.mags['GPMAG'] - 0.55 * \
                                (star.mags['GPMAG'] - star.mags['RPMAG']) - 0.03
            star.mags['BMAG'] = star.mags['GPMAG'] + 0.47 * \
                                (star.mags['GPMAG'] - star.mags['RPMAG']) + 0.17
            star.mags['RMAG'] = star.mags['VMAG'] - 0.59 * \
                                (star.mags['GPMAG'] - star.mags['RPMAG']) - 0.11
            if (star.mags['RPMAG'] - star.mags['IPMAG'] < 0.95):
                star.mags['IMAG'] = star.mags['RMAG'] - 1.00 * \
                                    (star.mags['RPMAG'] - star.mags['IPMAG']) \
                                    - 0.21
            else:
                star.mags['IMAG'] = star.mags['RMAG'] - 0.70 * \
                                    (star.mags['RPMAG'] - star.mags['IPMAG']) \
                                    - 0.49
            star.mags['UMAG'] = 1.333 * (star.mags['UPMAG'] - star.mags['GPMAG']) - 1.027 * (star.mags['BMAG'] - star.mags['VMAG']) - 0.960 + star.mags['BMAG']
            #del star.mags['UMAG']
